...
const AgentDashboard = () => {
  ...
  // Filter bookings based on search and category
  ...
  const handleProfileUpdate = async () => {
    setLoading(true);
    try {
      // TODO: Create updateProfile endpoint in backend
      // const response = await agentAuthService.updateProfile(profileForm);
      
      // For now, update local state (will be synced with Redux after backend API is ready)
      const updatedAgent = { ...agentInfo, ...profileForm };
  ...
  const handlePasswordChange = async () => {
    ...
    setLoading(true);
    try {
      // TODO: Create changePassword endpoint in backend
  ...
  const handleContinueBooking = () => {
    ...
    toast.info('Browse properties to continue booking');
  };
              ...
              <div className="hidden md:block overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Booking ID</th>
                    ...
                    <div key={booking.id} className="p-3 hover:bg-gray-50 transition-colors">
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex-1 min-w-0 pr-2">
                          <div className="flex items-center flex-wrap gap-1.5 mb-1">
                            <span className="text-xs font-semibold text-gray-900 truncate">{booking.id}</span>
                        ...
                        <div className="text-right flex-shrink-0">
                          <div className="text-xs font-semibold text-gray-900">₹{booking.amount.toLocaleString()}</div>
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-x-3 gap-y-1.5 mb-2 text-xs text-gray-600">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="truncate text-[11px]">{booking.roomType}</span>
                        </div>
                        <div className="flex items-center">
            ...
            <div className="p-4 sm:p-6 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-semibold text-gray-900 text-sm sm:text-base">{selectedBooking.id}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900 text-sm sm:text-base">{selectedBooking.roomType}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900 text-sm sm:text-base">{selectedBooking.bookingDate}</p>
                </div>
                <div>
                  <p className="text-xs sm:text-sm text-gray-600 mb-1">Total Amount</p>
                  <p className="font-semibold text-gray-900 text-base sm:text-lg">₹{selectedBooking.amount.toLocaleString()}</p>
                </div>
              </div>
            </div>
