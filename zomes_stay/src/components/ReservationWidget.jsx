          ...
          <div className="flex items-center justify-between mb-6">
            <button
              onClick={() => {
                ...
                console.log(`🔙 Previous month clicked: ${newMonth.getMonth() + 1}/${newMonth.getFullYear()}`);
            ...
            <button
              onClick={() => {
                ...
                console.log(`🔜 Next month clicked: ${newMonth.getMonth() + 1}/${newMonth.getFullYear()}`);
                if (onMonthNavigation) {
                  onMonthNavigation(newMonth.getMonth() + 1, newMonth.getFullYear());
                }
              }}
...
export default function ReservationBookingWidget({
  ...
  console.log(calendarData,unavailableDates, propertyDetails)
