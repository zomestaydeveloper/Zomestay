        ...
        <div className="w-full border rounded-lg shadow-lg px-4 py-4 border-gray-200 md:w-[60%] md:border-none md:shadow-none flex flex-col gap-2">
            <div className="flex flex-col md:flex-row md:items-baseline justify-start gap-8 border-b pb-4 mb-4 relative">
                ...
                <div className="relative">
                    ...
                    {showHighlights && (
                        <div className="absolute top-full right-0 md:left-1/2 md:right-auto md:-translate-x-1/2 mt-3 w-72 max-w-[calc(100vw-2.5rem)] bg-white rounded-xl shadow-xl border border-gray-100 z-50 p-4 animate-in fade-in zoom-in-95 duration-200">
                            <div className="absolute -top-2 right-6 md:left-1/2 md:right-auto md:-ml-2 w-4 h-4 bg-white transform rotate-45 border-t border-l border-gray-100"></div>
                            <h3 className="text-violet-900 font-bold text-sm mb-2 uppercase tracking-wide">Main Attractions</h3>
                            <ul className="space-y-2">
                                <li className="flex items-start gap-2 text-sm text-gray-600">
                                    <span className="text-violet-500 mt-0.5">★</span>
                                    <span>Infinity Pool with Mountain View</span>
                                </li>
                                <li className="flex items-start gap-2 text-sm text-gray-600">
                                    <span className="text-violet-500 mt-0.5">★</span>
