/*
  ...
  - A unique constraint covering the columns `[propertyId,code]` on the table `MealPlan` will be added. If there are existing duplicate values, this will fail.
...
-- DropIndex
DROP INDEX `MealPlan_code_key` ON `mealplan`;
