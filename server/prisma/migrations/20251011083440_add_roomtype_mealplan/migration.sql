...
-- AlterTable
ALTER TABLE `propertyroomtype` ADD COLUMN `baseMealPlanId` CHAR(36) NULL;
...
CREATE TABLE `PropertyRoomTypeMealPlan` (
    ...
    UNIQUE INDEX `PropertyRoomTypeMealPlan_propertyRoomTypeId_mealPlanId_key`(`propertyRoomTypeId`, `mealPlanId`),
    PRIMARY KEY (`id`)
...
-- AddForeignKey
ALTER TABLE `PropertyRoomType` ADD CONSTRAINT `PropertyRoomType_baseMealPlanId_fkey` FOREIGN KEY (`baseMealPlanId`) REFERENCES `MealPlan`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
