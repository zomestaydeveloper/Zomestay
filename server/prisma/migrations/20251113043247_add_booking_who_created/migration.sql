...
-- AlterTable
ALTER TABLE `booking` ADD COLUMN `agentId` CHAR(36) NULL,
    ADD COLUMN `createdById` CHAR(36) NULL,
    ADD COLUMN `createdByType` ENUM('admin', 'host', 'agent', 'user') NULL;

-- CreateIndex
CREATE INDEX `Booking_agentId_idx` ON `Booking`(`agentId`);

-- CreateIndex
CREATE INDEX `Booking_createdByType_idx` ON `Booking`(`createdByType`);
