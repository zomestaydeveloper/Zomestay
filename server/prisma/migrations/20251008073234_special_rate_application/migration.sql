...
-- CreateTable
CREATE TABLE `SpecialRateApplication` (
    `id` CHAR(36) NOT NULL,
    `specialRateId` CHAR(36) NOT NULL,
    `propertyId` CHAR(36) NOT NULL,
    `propertyRoomTypeId` CHAR(36) NULL,
    ...
    INDEX `idx_app_property_date_active`(`propertyId`, `dateFrom`, `dateTo`, `isActive`),
    INDEX `idx_app_roomtype_date_active`(`propertyRoomTypeId`, `dateFrom`, `dateTo`, `isActive`),
    INDEX `idx_app_rate`(`specialRateId`),
    UNIQUE INDEX `SpecialRateApplication_specialRateId_propertyId_propertyRoom_key`(`specialRateId`, `propertyId`, `propertyRoomTypeId`, `dateFrom`, `dateTo`),
    PRIMARY KEY (`id`)
