...
-- AlterTable
ALTER TABLE `propertyroomtype` ADD COLUMN `bedType` ENUM('SINGLE', 'DOUBLE', 'QUEEN', 'KING', 'TWIN', 'FULL', 'SOFA_BED', 'BUNK_BED', 'MURPHY_BED', 'WATER_BED', 'AIR_BED', 'CUSTOM') NOT NULL DEFAULT 'DOUBLE';
