/*
  ...
  - You are about to alter the column `mealPlanId` on the `booking` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Char(36)`.
  - You are about to drop the `ratecalendar` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `roomratecalendar` table. If the table is not empty, all the data it contains will be lost.
...
-- AlterTable
ALTER TABLE `booking` MODIFY `mealPlanId` CHAR(36) NULL,
    MODIFY `startDate` DATE NOT NULL,
    MODIFY `endDate` DATE NOT NULL;

-- AlterTable
ALTER TABLE `mealplan` MODIFY `description` TEXT NULL;

-- AlterTable
ALTER TABLE `promotion` MODIFY `validFrom` DATE NOT NULL,
    MODIFY `validTo` DATE NOT NULL;

-- AlterTable
ALTER TABLE `property` MODIFY `description` TEXT NULL,
    MODIFY `rulesAndPolicies` TEXT NULL;

-- AlterTable
ALTER TABLE `review` MODIFY `description` TEXT NULL;

-- AlterTable
ALTER TABLE `specialrateapplication` MODIFY `dateFrom` DATE NOT NULL,
    MODIFY `dateTo` DATE NOT NULL;

-- DropTable
DROP TABLE `ratecalendar`;

-- DropTable
DROP TABLE `roomratecalendar`;
