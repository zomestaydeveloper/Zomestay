...
CREATE TABLE `RatePlanDate` (
    ...
    INDEX `RatePlanDate_propertyId_idx`(`propertyId`),
    INDEX `RatePlanDate_ratePlanId_idx`(`ratePlanId`),
    INDEX `RatePlanDate_date_idx`(`date`),
    INDEX `RatePlanDate_isDeleted_idx`(`isDeleted`),
    UNIQUE INDEX `RatePlanDate_propertyId_date_isDeleted_key`(`propertyId`, `date`, `isDeleted`),
    PRIMARY KEY (`id`)
