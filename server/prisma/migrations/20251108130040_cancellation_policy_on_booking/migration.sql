...
-- AlterTable
ALTER TABLE `booking` ADD COLUMN `cancellationPolicyId` CHAR(36) NULL,
    ADD COLUMN `cancellationPolicySnapshot` JSON NULL;

-- CreateIndex
CREATE INDEX `Booking_cancellationPolicyId_idx` ON `Booking`(`cancellationPolicyId`);
