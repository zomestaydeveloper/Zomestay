...
-- CreateTable
CREATE TABLE `order_room_selections` (
    `id` CHAR(36) NOT NULL,
    ...
    `datesToBlock` JSON NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    INDEX `order_room_selections_orderId_idx`(`orderId`),
    INDEX `order_room_selections_roomTypeId_idx`(`roomTypeId`),
    PRIMARY KEY (`id`)
