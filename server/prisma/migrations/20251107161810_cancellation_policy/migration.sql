...
-- AlterTable
ALTER TABLE `property` ADD COLUMN `cancellationPolicyId` CHAR(36) NULL;
...
CREATE TABLE `CancellationPolicy` (
    ...
    INDEX `CancellationPolicy_isDeleted_idx`(`isDeleted`),
    INDEX `CancellationPolicy_isDefault_idx`(`isDefault`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `CancellationPolicyRule` (
    `id` CHAR(36) NOT NULL,
    `cancellationPolicyId` CHAR(36) NOT NULL,
    ...
    INDEX `CancellationPolicyRule_cancellationPolicyId_idx`(`cancellationPolicyId`),
    INDEX `CancellationPolicyRule_daysBefore_idx`(`daysBefore`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateIndex
CREATE INDEX `Property_cancellationPolicyId_idx` ON `Property`(`cancellationPolicyId`);
