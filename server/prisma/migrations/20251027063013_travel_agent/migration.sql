...
CREATE TABLE `TravelAgent` (
    ...
    `iataCertificate` VARCHAR(191) NULL,
    ...
    UNIQUE INDEX `TravelAgent_phone_key`(`phone`),
    INDEX `TravelAgent_isDeleted_idx`(`isDeleted`),
    INDEX `TravelAgent_status_idx`(`status`),
    INDEX `TravelAgent_approvedById_idx`(`approvedById`),
    PRIMARY KEY (`id`)
