/*
  ...
  - A unique constraint covering the columns `[ownerHostId,isDeleted]` on the table `Property` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `Property_ownerHostId_isDeleted_key` ON `Property`(`ownerHostId`, `isDeleted`);
