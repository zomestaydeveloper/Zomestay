...
-- AlterTable
ALTER TABLE `propertyroomtype` ADD COLUMN `numberOfBeds` INTEGER NOT NULL DEFAULT 1;

-- CreateTable
CREATE TABLE `PropertyRoomTypeAmenity` (
    `id` CHAR(36) NOT NULL,
    ...
    INDEX `PropertyRoomTypeAmenity_amenityId_idx`(`amenityId`),
    INDEX `PropertyRoomTypeAmenity_isDeleted_idx`(`isDeleted`),
    UNIQUE INDEX `PropertyRoomTypeAmenity_propertyRoomTypeId_amenityId_isDelet_key`(`propertyRoomTypeId`, `amenityId`, `isDeleted`),
    PRIMARY KEY (`id`)
