/*
  ...
  - Added the required column `color` to the `special_rates` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `special_rates` ADD COLUMN `color` VARCHAR(191) NOT NULL;
