...
-- CreateTable
CREATE TABLE `TravelAgentPropertyDiscount` (
    `id` CHAR(36) NOT NULL,
    ...
    INDEX `TravelAgentPropertyDiscount_agentId_idx`(`agentId`),
    INDEX `TravelAgentPropertyDiscount_propertyId_idx`(`propertyId`),
    INDEX `TravelAgentPropertyDiscount_isDeleted_idx`(`isDeleted`),
    UNIQUE INDEX `TravelAgentPropertyDiscount_agentId_propertyId_isDeleted_key`(`agentId`, `propertyId`, `isDeleted`),
    PRIMARY KEY (`id`)
