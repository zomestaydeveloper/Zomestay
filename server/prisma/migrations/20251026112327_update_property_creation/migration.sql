...
CREATE TABLE `PropertyRoomTypeMedia` (
    ...
    INDEX `PropertyRoomTypeMedia_propertyRoomTypeId_idx`(`propertyRoomTypeId`),
    INDEX `PropertyRoomTypeMedia_isDeleted_idx`(`isDeleted`),
    INDEX `PropertyRoomTypeMedia_order_idx`(`order`),
    PRIMARY KEY (`id`)
