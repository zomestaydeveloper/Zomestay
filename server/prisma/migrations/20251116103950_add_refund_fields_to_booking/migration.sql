...
-- AlterTable
ALTER TABLE `booking` ADD COLUMN `refundEligibleAmount` DECIMAL(10, 2) NULL,
    ADD COLUMN `refundPercentage` INTEGER NULL,
    ADD COLUMN `refundProcessedAt` DATETIME(3) NULL,
    ADD COLUMN `refundedAmount` DECIMAL(10, 2) NULL;
